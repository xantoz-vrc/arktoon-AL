...
UNITY_DECLARE_TEX2D_NOSAMPLER(_ALMask); uniform float4 _ALMask_ST;
...
float _ALBand0PulseOffset;
float _ALBand1PulseOffset;
float _ALBand2PulseOffset;
float _ALBand3PulseOffset;
